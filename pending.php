<?php
    ...
    if (!isset($_SESSION['UserID'])) {
      ...
      if (mysqli_num_rows($DBres) == 0) { // Si no hay compras con ese payment_id...
        ...
        $sqlqry = "INSERT INTO Compra(Fecha, CodCliente, Estado, CostoEnvio, payment_id) VALUES('$Fecha', '$IDCliente', '1', '$CostoEnvio', '$payment_id');";
    ...
    <form name="Compra" action="index.php" method="post">
      ...
      <div class="cuerpo">
        <div class="container">
          ...
          <?php if ($error != 1) { ?>
            <p id="titulo" style="color:yellow;">¡Compra Pendiente!</p>
            <p>Usted acaba de registrar una compra, pero el sistema de Mercado Pago nos ha informado que su pago permanece pendiente. Ni bien esté confirmado el pago, un vendedor se comunicará para coordinar el envío.</p>
