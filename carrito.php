<?php
  if (isset($_SESSION['carrito'])) {
    ...
    for ($i = 0; $i < count($_SESSION['carrito']); $i++) {
      $cantidad_carrito = $arreglocarrito[$i]['Cantidad'] + $cantidad_carrito;
    }
    $visible = 1;
  }
  else $cantidad_carrito = 0;
  //echo "visible: $visible";
?>
<div class="carrito">
  <div id="numero_carrito" <?php if ($visible == 1) echo "style='display: block;cursor:pointer;'"; else  echo "style='display: none;cursor:pointer;'";?> onclick="Javascript:VerCarrito();"><?php echo $cantidad_carrito ?></div>
  <a href="Javascript:VerCarrito();"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
     viewBox="0 0 260.293 260.293" style="enable-background:new 0 0 260.293 260.293;" xml:space="preserve">
  <g>
    <path id="carrito_de_compras" d="M258.727,57.459c-1.42-1.837-3.612-2.913-5.934-2.913H62.004l-8.333-32.055c-0.859-3.306-3.843-5.613-7.259-5.613H7.5
    ...
    <path d="M203.512,188.62c-15.104,0-27.392,12.29-27.392,27.395c0,15.108,12.288,27.4,27.392,27.4
      ...
      C215.908,222.853,210.347,228.415,203.512,228.415z"/></g>
    </svg></a>
</div>
