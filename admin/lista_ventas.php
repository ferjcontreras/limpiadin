    ...
    if ($estadonuevo != "") {
      ...
      if ($estadonuevo == 2) { // Se confirmó el pedido
        ...
        while($DBarr = mysqli_fetch_row($DBres)) {
          ...
          else DescontarStockCombo($DBarr[1], $DBarr[0], "Confirmación de Compra N° $id_compra");
        }
      }
        ...
        while($DBarr = mysqli_fetch_row($DBres)) {
          //echo "IDCategoria: ".$DBarr[2]."<br>";
          if ($DBarr[2] != 1) AumentarStock($DBarr[1], $DBarr[0], "Pendiente de Compra N° $id_compra");
          else AumentarStockCombo($DBarr[1], $DBarr[0], "Pendiente de Compra N° $id_compra");
        }
      }
    }
?>
