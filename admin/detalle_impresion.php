...
<html lang="es" dir="ltr">
  <head>
    ...
    <script type="text/javascript">
      function Regresar() {
        document.forms['DetallePedido'].target = "";
        document.forms['DetallePedido'].action = 'imprimir_pedidos.php';
        document.forms['DetallePedido'].Flag.value = 0;
        document.forms['DetallePedido'].submit();
      }
      function Imprimir(id, tipo) {
        //alert("hola");
        document.forms['DetallePedido'].target = "_blank";
        document.forms['DetallePedido'].tipo.value = tipo;
        document.forms['DetallePedido'].id_pedido.value = id;
        document.forms['DetallePedido'].id_compra.value = id;
        document.forms['DetallePedido'].action = "generar_pdf.php";
        document.forms['DetallePedido'].submit();
      }
    </script>
  </head>
      ...
      <div class="cuerpo">
        <div class="container">
          <?php if ($Flag != "") { ?><p id="titulo" style="color:green;">¡Cambios Registrados!</p><?php } ?>
            ...
            <div class="col-sm-12">
              <center><p id="titulo"><?php if ($tipo == 'p') echo "Pedido"; else echo "Compra Mercado Libre"?> N° <b><?php echo $IDPedido[0] ?></b></p></center>
            </div>
          ...
          <div class="caja row" style="margin-top:1em;">
            ...
            <div class="col-sm-1">
              <input type="button" name="" value="Imprimir" class="boton_verde" onclick="javascript:Imprimir(<?php echo $IDPedido[0] ?>, '<?php echo $tipo ?>');">
            </div>
          </div>
        </div>
