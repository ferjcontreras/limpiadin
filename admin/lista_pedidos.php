...
<html lang="es" dir="ltr">
  <head>
    ...
    <script type="text/javascript">
      function Filtrar() {
        var estado = document.forms['Pedidos'].estado.options[document.forms['Pedidos'].estado.selectedIndex].value;
      ...
      function CargarContenido(estado){
        ...
        var parameters = "estado="+estado+"&email="+email+"&userpf=<?php echo $_SESSION["UserPfAdmin"] ?>&userid=<?php echo $_SESSION["UserIDAdmin"] ?>&nombre="+nombre;
        xhttp.open("POST", "../ajax/pedidos.php", true);
      ...
      function VerDetalle(cual) {
        ...
        document.forms['Pedidos'].action = "detalle_pedido.php";
      ...
      function CambiarEstado(id, nuevo, actual) {
        ...
        document.forms['Pedidos'].estadoactual.value = actual;
        document.forms['Pedidos'].submit();
      }
      function Regresar() {
  ...
  <body onload="CargarContenido(0);">
    <form name="Pedidos" action="lista_pedidos.php" method="post">
      ...
      <div class="cuerpo">
        ...
        <div class="container">
          <p id="titulo">Listado de Pedidos</p>
          <div class="filtro">
            <div class="row">
              <div class="col-sm-4 offset-sm-1">
                <p>Mostrar solamente pedidos:</p>
              </div>
              <div class="col-sm-4">
            ...
            <div class="row">
              <div class="col-sm-4 offset-sm-1">
                <p>Buscar por Nombre de Cliente:</p>
              </div>
              <div class="col-sm-4">
                <input type="text" name="nombre" value="" onkeydown="javascript:Filtrar()" style="width:100%;">
              </div>
            </div>
          </div>
